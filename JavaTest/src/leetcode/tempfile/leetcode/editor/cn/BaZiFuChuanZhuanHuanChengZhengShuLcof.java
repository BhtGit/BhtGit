...
public class BaZiFuChuanZhuanHuanChengZhengShuLcof {
    ...
    public static void main(String[] args) {
        Solution solution = (Solution) Common.getSolution(BaZiFuChuanZhuanHuanChengZhengShuLcof.class);
        System.out.println(solution.strToInt("  -0012a42"));
    }
//}

// 第剑指 Offer 67题：把字符串转换成整数
...
class Solution {
    public int strToInt(String str) {
        ...
        while (index < str.length()) {
            ...
            if (res > Integer.MAX_VALUE / 10 || (res == Integer.MAX_VALUE / 10 && chars[index] > '7')) {
