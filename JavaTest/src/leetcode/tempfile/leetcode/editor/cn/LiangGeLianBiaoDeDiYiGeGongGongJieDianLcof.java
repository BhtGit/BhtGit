...
public class LiangGeLianBiaoDeDiYiGeGongGongJieDianLcof {
    ...
    public static void main(String[] args) {
        Solution solution = (Solution) Common.getSolution(LiangGeLianBiaoDeDiYiGeGongGongJieDianLcof.class);

    }
//}

// 第剑指 Offer 52题：两个链表的第一个公共节点
//输入两个链表，找出它们的第一个公共节点。 
//
// 如下面的两个链表： 
//
...
//lists/ 
// 
// Related Topics 哈希表 链表 双指针 👍 376 👎 0
